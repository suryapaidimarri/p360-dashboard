                                ...
                                {group.types.map(ct => {
                                  ...
                                  return (
                                    <button key={ct.id}
                                      ...
                                      title={ct.label}
                                      style={{ display:'flex', flexDirection:'column' as const, alignItems:'center', gap:3, padding:'5px 3px', borderRadius:6, border:`2px solid ${active?'#1a73e8':'#e0e0e0'}`, background:active?'#e8f0fe':'#fff', cursor:'pointer', transition:'all 0.1s', width:60, minWidth:60 }}>
                          ...
                          <div style={{ display:'flex', flexWrap:'wrap' as const, gap:6, marginBottom:6 }}>
                            {group.types.map(ct => (
                              <button key={ct.id} onClick={() => addWidget(ct.id, ct.label)}
                                title={`Add ${ct.label}`}
                                style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:3, padding:'5px 3px', borderRadius:6, border:'2px solid #e0e0e0', background:'#fff', cursor:'pointer', width:60, minWidth:60, transition:'all 0.1s' }}
                                onMouseEnter={e=>{(e.currentTarget as HTMLButtonElement).style.borderColor='#1a73e8';(e.currentTarget as HTMLButtonElement).style.background='#e8f0fe'}}
